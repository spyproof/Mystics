 ...
 * Created by Spyproof.
 */
public class BottledFluidLightning extends BaseItem
{
    public BottledFluidLightning()
    {
        super();
        this.setUnlocalizedName(Names.Items.BOTTLED_FLUID_LIGHTNING);
    }
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean p_77624_4_)
    {
        ...
        list.add("electricity safely inside");
    }
